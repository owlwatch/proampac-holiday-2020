...
},{"process":"node_modules/process/browser.js"}],"node_modules/ev-emitter/ev-emitter.js":[function(require,module,exports) {
var define;
var global = arguments[3];
/**
 * EvEmitter v1.1.0
...
},{"ev-emitter":"node_modules/ev-emitter/ev-emitter.js"}],"js/easing.js":[function(require,module,exports) {
"use strict";
...
var $scrollArrow = (0, _jquery.default)('button[data-action="scroll"]');
var $headerBg = (0, _jquery.default)('.header__bg');
var $footerBg = (0, _jquery.default)('.footer__bg');
var animate = {
  '.header__top': [{
    start: 3,
    end: 3.8,
    easing: 'easeOutQuad',
    callback: function callback(v, selector) {
      (0, _jquery.default)(selector).css('opacity', 1 - v);
      (0, _jquery.default)(selector).css('transform', 'translate3d(0, ' + v * -300 + 'px, 0)');

      if (v === 1) {
        (0, _jquery.default)(selector).hide();
      } else {
        (0, _jquery.default)(selector).show();
      }
    }
  }],
  '.header__bg': [{
    ...
    easing: 'easeOutQuad',
    callback: function callback(v, selector) {
      (0, _jquery.default)(selector).css({
  ...
  '.header__from-our-family': [{
    ...
    easing: 'easeOutQuad',
    callback: function callback(v, selector) {
      (0, _jquery.default)(selector).css('opacity', v);
      (0, _jquery.default)(selector).css('transform', 'translate3d(0, ' + (1 - v) * 50 + 'px, 0)');
  ...
  '.footer': [{
    ...
    easing: 'easeOutQuad',
    callback: function callback(v, selector) {
      (0, _jquery.default)(selector).css('background-position', '50% ' + v * (document.documentElement.clientHeight * -0.1) + 'px');
    }
  }],
...
function resizeBackgrounds() {
  ...
  image.onload = function () {
    ...
    var imageScale = image.width / image.height;
    $headerBg.css({
...
function update() {
  ...
  windowHeight = (0, _jquery.default)(window).height();
  windowWidth = (0, _jquery.default)(window).width();

  var _loop = function _loop(selector) {
    var animations = animate[selector];
    var done = false;
    animations.forEach(function (animation) {
      var percent = 0;
      var start = animation.start * windowHeight;
      var end = animation.end * windowHeight;
      ...
      var i = _easing.default[animation.easing](percent);

      if (animation.style) {
        for (var prop in animation.style) {
          var fromTo = animation.style[prop];
          var s = fromTo[1] - fromTo[0];
          var v = fromTo[0] + s * percent;
          (0, _jquery.default)(selector).css(prop, v);
        }
      }

      if (animation.callback) {
        animation.callback.apply(_this, [percent, selector, animation]);
      }
  ...
  for (var selector in animate) {
    _loop(selector);
  }
}

function init() {
  var $intro = (0, _jquery.default)('.header__top').find('img');
  $intro.each(function (i) {
    var _this2 = this;

    setTimeout(function () {
      (0, _jquery.default)(_this2).addClass('fade-in');
    }, ($intro.length - i) * 450);
  });
...
(0, _imagesloaded.default)(document.body, init);

function onScroll() {
  $scrollArrow.removeClass('bounce');
  (0, _jquery.default)('footer.actions').addClass('scrolling');
}

function onScrollStop() {
  $scrollArrow.addClass('bounce');
  (0, _jquery.default)('footer.actions').removeClass('scrolling');
}
